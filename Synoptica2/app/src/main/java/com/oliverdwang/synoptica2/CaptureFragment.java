...
public class CaptureFragment extends Fragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Log.v("camera id",manager.getCameraIdList()[1]);
    ...
    private void stopRecordingVideo() {
        ...
        mButtonVideo.setImageResource(R.drawable.ic_action_start);
        // Stop recording
        mMediaRecorder.stop();
        ...
        if (null != activity) {
            ...
            //SAVE VIDEO AND STUFF TO DATABASE
            saveToDatabase(mNextVideoAbsolutePath);
        }
    ...
    private void saveToDatabase(String path) {
        ...
        View view = inflater.inflate(R.layout.alertdialog_save, null);
        ...
        RdBtnGrp = view.findViewById(R.id.rdgrp);
        URI = view.findViewById(R.id.editText_URI);
        URI.setText(mNextVideoAbsolutePath);
